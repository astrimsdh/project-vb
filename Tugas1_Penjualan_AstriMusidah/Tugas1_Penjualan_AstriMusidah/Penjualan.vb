Public Class Penjualan
    ...
    Private Sub kode_astri_TextChanged(sender As Object, e As System.EventArgs) Handles kode_astri.TextChanged
        ...
        jmlBeli_astri.Focus()
    End Sub
    Private Sub jmlBeli_astri_TextChanged(sender As Object, e As System.EventArgs) Handles jmlBeli_astri.TextChanged
    ...
    Private Sub diskon_astri_TextChanged(sender As Object, e As System.EventArgs) Handles diskon_astri.TextChanged
        total_astri.Text = Val(jmlBayar_astri.Text) - Val(diskon_astri.Text)
    End Sub
